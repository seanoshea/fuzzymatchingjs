...
function matchAlphabet(pattern) {
  ...
  if (_requestPromise2.default) {
    console.log(_requestPromise2.default);
  }
  var s = {};
...
exports.default = { confidenceScore: confidenceScore, fuzzyMatchPattern: fuzzyMatchPattern, sortArrayByFuzzyMatchPattern: sortArrayByFuzzyMatchPattern };
